                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_user_jefe" type="text" class="form-control @error('id_user_jefe') is-invalid @enderror" name="id_user_jefe" value="{{ old('id_user_jefe') }}" required autocomplete="id_user_jefe" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_empresa" type="text" class="form-control @error('id_empresa') is-invalid @enderror" name="id_empresa" value="{{ old('id_empresa') }}" required autocomplete="id_empresa" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_aplicacion" type="text" class="form-control @error('id_aplicacion') is-invalid @enderror" name="id_aplicacion" value="{{ old('id_aplicacion') }}" required autocomplete="id_aplicacion" >
