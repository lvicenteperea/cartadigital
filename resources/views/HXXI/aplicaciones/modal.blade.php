<!-- Modal para DELETE-->
<div class="modal modal-danger fade" id="modal-delete-{{$apli->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('hxxi.aplicaciones.borrar', ['hxxi_aplicacion' => $apli]) }}" method="POST">
                @csrf
                @method('DELETE')
