<!-- Modal para DELETE-->
<div class="modal modal-danger fade" id="modal-delete-{{$disp->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('hxxi.dispositivos.borrar', ['hxxi_dispositivo' => $disp]) }}" method="POST">
                @csrf
                @method('DELETE')
